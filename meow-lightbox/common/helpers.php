...
if ( !class_exists( 'MeowKit_MWL_Helpers' ) ) {

  class MeowKit_MWL_Helpers {
    //public static $version = MeowKit_MWL_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MWL_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MWL_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MWL_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MWL_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MWL_Helpers::$startQueries[ $timerName ];
